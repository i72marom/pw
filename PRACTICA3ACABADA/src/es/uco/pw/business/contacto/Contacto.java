...
public class Contacto {
	 ...
	 * @param tags
	 */
	public Contacto(String nombre, String apellido1, String apellido2, int edad, String email, LocalDate fechaCumpleanos, ArrayList<String> tags, String password, boolean admin) {
	...
	/**
	 * Getter de la fecha de cumpleaños
	 * @return
	 */
