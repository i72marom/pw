...
public class MySQLContactoDAO implements ContactoDAO{
	...
	public void insertar(Contacto a) throws DAOException{
		...
		try {
			...
			if(a.getTags()!=null)
				stat.setString(8, a.getTags().toString());
			else
				stat.setString(8, "");
	...
	private Contacto convertir(ResultSet a) throws SQLException
	{
		...
		boolean admin = a.getBoolean("admin");
		...
		Contacto contacto = new Contacto(nombre, apellido1, apellido2, edad, email, fechaCumpleanos, tags, password, admin);
	...
	public void Modificar(Contacto a) throws DAOException {
		...
		try {
			...
			stat.setBoolean(9, a.getAdmin());
			stat.setLong(10, a.getId());
