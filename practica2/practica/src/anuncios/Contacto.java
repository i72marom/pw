...
public class Contacto {
	 ...
	 * @param tags
	 */
	public Contacto(String nombre, String apellido1, String apellido2, int edad, String email, int dia, int mes, int anyo, ArrayList<String> tags, String password) {
	...
	public String toString() {
		return "Contacto [Nombre=" + nombre + " | apellido1=" + apellido1 + " | apellido2=" + apellido2 + " | email="
				+ email + " | edad=" + edad + " | Fecha_cumpleaños=" + diaCumpleanos+"/"+mesCumpleanos+"/"+anyoCumpleanos + " | tags= " + tags_.toString() + "]\n";
	}
