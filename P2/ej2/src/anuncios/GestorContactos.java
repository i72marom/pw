...
public class GestorContactos {
		...
		File archivo = null;
	      ...
	      try {
	         ...
	         while((linea=br.readLine())!=null)
	         {
	        	 ...
	        	 diaCumpleanos = Integer.parseInt(lineaSpliteada[6]);
	        	 mesCumpleanos = Integer.parseInt(lineaSpliteada[7]);
	        	 anyoCumpleanos = Integer.parseInt(lineaSpliteada[8]);
	        	 for(int i = 9;i<lineaSpliteada.length;i++)
	        	 {
	        	 ...
	        	 Contacto contacto = new Contacto(id, nombre, apellido1, apellido2, edad, email, diaCumpleanos, mesCumpleanos, anyoCumpleanos, tags);
	...
	public void guardarContactos() {
        ...
        try
        {
            ...
            {
            	  pw.print(contactos_.get(i).getId() + ", " + contactos_.get(i).getNombre() + ", " + contactos_.get(i).getApellido1() + ", " + contactos_.get(i).getApellido2() + ", " + contactos_.get(i).getEdad() + ", " + contactos_.get(i).getEmail() + ", " + contactos_.get(i).getDiaCumpleanos() + ", " + contactos_.get(i).getMesCumpleanos() + ", " + contactos_.get(i).getAnyoCumpleanos() + ", ");
	...
	public boolean darAltaContacto() {
		...
		Contacto nuevoContacto = new Contacto(id_, nombre, apellido1, apellido2, edad, email, diaCumpleanos, mesCumpleanos, anyoCumpleanos, tags_user);
